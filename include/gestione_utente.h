...
int setup_server_p2p(int porta); // Restituisce il file descriptor del socket di ascolto verso i peer

// Gestione Input
void gestisci_input_tastiera();
int gestisci_messaggio_lavagna(); // Restituisce 0 se la lavagna si è disconnessa, 1 se è andato tutto bene
...
int richiedi_review_ai_peer(int * lista_porte, int num_utenti); // Restituisce il numero di peer che hanno approvato il lavoro
